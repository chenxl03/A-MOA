...
for i=1:253
    for j=1:253
        ...
        for k=1:6
            error_g(i,j,k)=error_amoae4_8(d8g_bin(k,:),d8g_bin(k+1,:),d8g_bin(k+2,:));
        end
        ...
        for k=1:6
            error_a(i,j,k)=error_amoae4_8(d8a_bin(k,:),d8a_bin(k+1,:),d8a_bin(k+2,:));
        end
        ...
        for k=1:6
            error_r(i,j,k)=error_amoae4_8(d8r_bin(k,:),d8r_bin(k+1,:),d8r_bin(k+2,:));
        end
